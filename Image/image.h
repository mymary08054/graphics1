...
private:
/*helper method to keep rgb values in correct range*/
    int rgbTruncate(int value) const;
    int quantizeRound(int qRanges [], int qValues [], int rgbValue, int qBits) const;
    int orderedDitherRound( int qValues [], int valueBit, int rgbValue, int qBits, int dMatrix[2][2], int i, int j, int bits) const;
};
/**/
