...
int Image32::getR(int x, int y) const
{
    return this->pixel(x,y).r;
}

int Image32::getG(int x, int y) const
{
    return this->pixel(x,y).g;
}

int Image32::getB(int x, int y) const
{
    return this->pixel(x,y).b;
}
